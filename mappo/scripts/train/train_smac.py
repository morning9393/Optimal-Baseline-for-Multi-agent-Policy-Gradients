...
sys.path.append("../../")
from mappo.config.config_smac import get_config
from mappo.envs.starcraft2.StarCraft2_Env import StarCraft2Env
from mappo.envs.starcraft2.smac_maps import get_map_params
