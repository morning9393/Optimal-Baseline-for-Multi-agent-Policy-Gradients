...
sys.path.append("../../")
from mappo.config.config_mujoco import get_config
from mappo.envs.ma_mujoco.multiagent_mujoco.mujoco_multi import MujocoMulti
from mappo.runner.shared.mujoco_runner import MujocoRunner as Runner
