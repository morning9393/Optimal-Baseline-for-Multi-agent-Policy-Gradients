...
from mappo.envs.hanabi.Hanabi_Env import HanabiEnv
from mappo.envs.env_wrappers import ChooseSubprocVecEnv, ChooseDummyVecEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from mappo.runner.shared.hanabi_runner_forward import HanabiRunner as Runner
    else:
        from mappo.runner.separated.hanabi_runner_forward import HanabiRunner as Runner
